...
SYSVerification.prototype = {
	...
	_initial: function(options) {
		...
		var par = {
			...
			Passwordlength:6,
			Editmode:'',//编辑模式
			Loading: '<div class="padding05"><img src="images/timg.gif" style="width:45px;height:45px"></div>', //加载样式设置
			Verify_Promptcode: 101, //验证码返回数字
			ConfirmCode: 202, //确认返回数字
			FailureCode: 102, //失败认证码
			FailurePrompt: '用户名或者密码错误，请从新输入', //请求失败提示
